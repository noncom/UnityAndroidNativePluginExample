...
//extern "C" int SetTextureFromUnity(void* textureHandle, int w, int h)
{
    // A script calls this at initialization time; just remember the texture pointer here.
    // Will update texture pixels each frame from the plugin rendering event (texture update
    // needs to happen on the rendering thread).
//    printf("------------------------- SET TEXT FROM UNITY\n");
//    ::fprintf(stderr, "---ERR------------------ SET TEXT FROM UNIT--------------------- SET TEXT FROM UNIT  \n");
//    ::fprintf(stdout, "---OUT------------------ SET TEXT FROM UNIT--------------------- SET TEXT FROM UNIT  \n");
    //fflush(stdout);
...
static void ModifyTexturePixels()
{
    ...
    printf("--------------------------- TEX HANDLE:");
    //fflush(stdout);
    printf("--------------------------- TEX HANDLE: %b", !textureHandle);
    //fflush(stdout);
    if (!textureHandle)
        return;
    ...
    printf("--------------------------- TEX PTR");
    //fflush(stdout);
    printf("--------------------------- TEX PTR %b", !textureDataPtr);
    //fflush(stdout);
    if (!textureDataPtr)
        return;
    ...
    printf("--------------------------- TEX END");
    //fflush(stdout);
    printf("--------------------------- TEX END %b", !textureDataPtr);
    //fflush(stdout);
